  ...
  (let ()
    ...
    (define op-emit-table
      ...
      '((pointer-move            1 "$0 = %0"                                0)
        ...
        (dh-cmsub-a              3 "$0 = __fxcpmsub(%0, %2, __creal(%1))"   4)
        ...
        (dh-dot-add-i-b          3 "$0 = __fxpmadd(%0, %2, __cimag(%1))"    4)
        (dh-dot-sub-a            3 "$0 = __fxcpmsub(%0, %2, __creal(%1))"   4)
        (dh-dot-sub-b            3 "$0 = __fxcxnpma(%0, %2, __cimag(%1))"   4)
        (dh-dot-sub-i-a          3 "$0 = __fxcxnsma(%0, %2, __creal(%1))"   4)
        (dh-dot-sub-i-b          3 "$0 = __fxcpmsub(%0, %2, __cimag(%1))"   4)
        (dh-dot-fini             1 "$0 = %0"                                0)
