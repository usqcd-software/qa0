...
(define machine-bgl/xlc
  (let ()
	...
	(dh-rmsub                3 "$0 = __fxcpmsub(%0, %2, %1)"            4)
	...
	(dh-c2mul-a              2 "$0 = __fxpmul(%0, __creal(%1))"         2)
	(dh-c2mul-b              3 "$0 = __fxcxnsma(%1, %2, __cimag(%0))"   4)
	(dh-cmadd-a              3 "$0 = __fxcpmadd(%0, %2, __creal(%1))"   4)
	(dh-cmadd-b              3 "$0 = __fxcxnsma(%0, %2, __cimag(%1))"   4)
	(dh-c2madd-a             3 "$0 = __fxcpmadd(%1, %2, __creal(%0))"   4)
	(dh-c2madd-b             3 "$0 = __fxcxnsma(%1, %2, __cimag(%0))"   4)
	(dh-dcmul                2 "$0 = __fpmul(%0, %1)"                   2)
	(dh-dcmadd               3 "%0 = __fpmadd(%0, %1, %2)"              4)
