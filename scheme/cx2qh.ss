  ...
  (let ()
    ...
    (define qh-optable
      (list
       ...
       (cons 'complex                      (/-rename 1 1 'qh-make))
       ...
       (cons 'complex-mul                  (/-split2 1 2 'qh-mul       'qh-mul-a       /in-all  'qh-mul-b))
       (cons 'complex-madd                 (/-split2 1 3 'qh-madd      'qh-madd-a      /in-tail 'qh-madd-b))
       (cons 'complex-msub                 (/-split2 1 3 'qh-msub      'qh-msub-a      /in-tail 'qh-msub-b))
       (cons 'complex-rmadd                (/-rename 1 3 'qh-rmadd))
       (cons 'complex-rmsub                (/-rename 1 3 'qh-rmsub))
       (cons 'complex-cmul                 (/-split2 1 2 'qh-cmul      'qh-cmul-a      /in-all  'qh-cmul-b))
       (cons 'complex-cmadd                (/-split2 1 3 'qh-cmadd     'qh-cmadd-a     /in-tail 'qh-cmadd-b))
       (cons 'complex-cmsub                (/-split2 1 3 'qh-cmsub     'qh-cmsub-a     /in-tail 'qh-cmsub-b))
       ...
       (cons 'complex-dot-add              (/-split2 1 3 'qh-dot-add   'qh-dot-add-a   /in-tail 'qh-dot-add-b))
       (cons 'complex-dot-add-i            (/-split2 1 3 'qh-dot-add-i 'qh-dot-add-i-a /in-tail 'qh-dot-add-i-b))
       (cons 'complex-dot-sub              (/-split2 1 3 'qh-dot-sub   'qh-dot-sub-a   /in-tail 'qh-dot-sub-b))
       (cons 'complex-dot-sub-i            (/-split2 1 3 'qh-dot-sub-i 'qh-dot-sub-i-a /in-tail 'qh-dot-sub-i-b))
       (cons 'complex-dot-fini             (/-rename 1 1 'qh-dot-fini))))
    (define (cx->qh-op code attr* name output* input* r*)
      (let ([trans (assq name qh-optable)])
        (cond
         [trans ((cadr trans) name attr* output* input* r*)]
         [else (cons code r*)])))
